...
- Next conf. call will be held in 16th October. 
...
| ------------- | -------- | ------ | ----------- |
| 20231102-04 | API backlog WG Chair | Open | Nominate the API proposal for TSC appproval. **Deadline**: 9 Nov 2023. |
| 20231102-03 | Vodafone | Open | To add the company names (via PR) in the 'supporters' column in [API backlog table](https://github.com/camaraproject/WorkingGroups/blob/main/APIBacklog/documentation/APIBacklog.md) for KYC Age Verification, if willing to become supporter of this API.|
...
| 20231102-01 | Telefónica | Open | 7-day mail approval on the new slots for API backlog WG call. |
