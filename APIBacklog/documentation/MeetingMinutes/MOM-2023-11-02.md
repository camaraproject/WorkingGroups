...
| 20231102-03 | Vodafone | Open | To add the company name (via PR) in the 'supporters' column in [API backlog table](https://github.com/camaraproject/WorkingGroups/blob/main/APIBacklog/documentation/APIBacklog.md) for KYC Age Verification, if willing to become supporter of this API.|
