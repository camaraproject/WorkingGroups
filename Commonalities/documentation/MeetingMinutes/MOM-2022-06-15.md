...
|  | [Issue #26: Reference NEF](https://github.com/camaraproject/WorkingGroups/issues/26):<br>We need a reference NEF on which the code can be based - investigating with Nokia |
